...
Name it something like Level Up.
Edit the bookmark.
Paste the complete bookmarklet code into the URL field.
Make sure the URL starts with javascript:.
Open a Dynamics 365 / Power Apps model-driven application.
Click the bookmark.
Features
